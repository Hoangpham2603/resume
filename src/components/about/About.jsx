    ...
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          <a
            className="button button--flex my__cv"
            href={CV}
          >
            My CV
            <svg
          ...
          <div className={request ? "cv__modal cv__active" : "cv__modal"}>
            <div className="cv__modal-content">
              <i className="uil uil-times cv__modal-close" onClick={handleClick}></i>
              <div className="cv__modal-box">
                <h3 className="cv__modal-text">Download CV ?</h3>
                <a
                  className="button button--flex"
